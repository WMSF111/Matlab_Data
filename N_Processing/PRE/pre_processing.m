...
% 平滑数据保存文件
smooth_mat_file_name = sprintf('%s\\Data processing\\Result\\Smooth\\N\\Smooth_Results.mat', ...
                       folder);
smooth_file_name = sprintf('%s\\Data processing\\Result\\Smooth\\N\\Smooth_Results.tif', ...
                   folder);  
%% 加载数据
